    ...
    <div
      ...
      {isMobile ? (
        <div style={{ padding: 20 }} className="flex flex-col justify-center items-center">
          <Image style={{ width: 144, height: 23.16 }} src={footerlogo} alt="logo" unoptimized />
          ...
          <div className="w-full flex justify-center items-center flex-col mt-4">
            <div className="flex justify-center items-center" style={{ backgroundColor: "#B9FF66", width: 112, borderRadius: 7 }}>
              <h3>Contact Us</h3>
            </div>
          ...
          <div className="my-6">
            <Image style={{ width: 130, height: 30 }} src={socials} alt="logo" unoptimized />
          </div>
          ...
          <div className="w-full mt-4 flex flex-row">
            <div className="flex justify-start items-start flex-col w-1/2">
              ...
              <div className="text-white mt-4 flex flex-col justify-start items-start">
                <h3 className="mt-2 text-center">Email: wahyufiver.id@gmail.com</h3>
                <h3 className="mt-2 text-center">Phone: 555-567-8901</h3>
                <h3 className="mt-2 text-center">Address: 1234</h3>
                <h3 className="mt-2 text-center">Malang, Jawa Timur,Indonesia</h3>
              </div>
            </div>
          </div>
          <div style={{ borderColor: "#fff", borderWidth: 1, marginTop: 10, marginBottom: 10 }} className="w-full" />
          <div className="my-4 flex flex-row justify-start items-center">
            <h4 className="text-white">© 2023 Codingin. All Rights Reserved.</h4>
          </div>
        </div>
      )}
    </div>
